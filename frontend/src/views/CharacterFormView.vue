        ...
        <div class="prompt-grid">
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              class="intro-textarea"
              placeholder="Der aktuelle Plot des Rollenspiels. Wird beim Generieren eines Plots automatisch überschrieben."
            ></textarea>
            <small class="hint">
              Wird nach dem Intro an den System Prompt angehängt (System Prompt → Intro → Plot).
              Beim Generieren eines Plots wird das Feld automatisch überschrieben. Leer lassen, um
              nichts anzuhängen.
            </small>
          </div>
