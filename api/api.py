...
from win_asyncio_patch import silence_proactor_connection_reset


# Mute the benign WinError 10054 spam from the Proactor loop on Windows.
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        llm_service = LLMService(
            model_path, n_ctx=n_ctx, n_gpu_layers=n_gpu_layers, enable_thinking=enable_thinking
        )
