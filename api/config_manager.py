...
class ConfigManager:
    ...
    def get_enable_thinking(self) -> bool:
        """Return whether the model's reasoning output is enabled.

        Defaults to True when the setting is not present in the configuration.
        """
        return self.get_config().get("enable_thinking", True)
