...
import asyncio
from dependencies import get_character_agent, get_chat_history, get_chat_repository, get_character_repository, get_llm_lock
from character_agent import CharacterAgent
from chat_history import ChatHistory
from chat_repository import ChatRepository
from character_repository import CharacterRepository
from schemas import AssistantMessageInsert, AssistantMessageRequest, ChatMessage, ChatMessageUpdate, DirectorMessage, PlotGenerateRequest, PlotMessage
...
async def summarize_chat(
    ...
    async with llm_lock:
        summary_result = await asyncio.to_thread(agent.create_summary)
