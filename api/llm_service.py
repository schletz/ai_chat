...
class LLMService:
    ...
    def send_command(
        ...
        print(f"📊 Tokens: {prompt_t} (Prompt) + {completion_t} (Response) = {total_t} (Total)")
        print(f"🚀 Speed: {tps:.2f} Tokens/Second (End-to-End)")
        print(f"Length limit exceeded? {hasLengethExeeded}")
